...
#Create Reference File for GTFs
os.system('cat %s | ./scripts/gtf_parse.sh > species/human/ids.txt' % args.human_index)
os.system('cat %s | ./scripts/gtf_parse.sh > species/mouse/ids.txt' % args.mouse_index)
